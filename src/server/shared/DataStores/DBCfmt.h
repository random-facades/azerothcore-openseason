...
char constexpr GtBarberShopCostBasefmt[] = "af";
char constexpr GtCombatRatingsfmt[] = "af";
char constexpr GtChanceToMeleeCritBasefmt[] = "af";
char constexpr GtChanceToMeleeCritfmt[] = "af";
char constexpr GtChanceToSpellCritBasefmt[] = "af";
char constexpr GtChanceToSpellCritfmt[] = "af";
char constexpr GtNPCManaCostScalerfmt[] = "af";
char constexpr GtOCTClassCombatRatingScalarfmt[] = "af";
char constexpr GtOCTRegenHPfmt[] = "af";
//char constexpr GtOCTRegenMPfmt[] = "f";
char constexpr GtRegenHPPerSptfmt[] = "af";
char constexpr GtRegenMPPerSptfmt[] = "af";
